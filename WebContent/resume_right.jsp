...
<div id="resumeSavePreview">
				...
				<div id="resumeFull">
					<div class="tn-instructions tn-border-gray tn-border-bottom">
					    <p class="tn-progress-text"><span class="tn-text-note">简历完整度</span><strong class="tn-action">?%</strong></p>
					    <div class="tn-progress-bar tn-widget-content tn-corner-all">
					        <div class="tn-progress-bar-value tn-widget-header tn-corner-left tn-border-tbl" style="width: 0%" ></div>
					    </div>
					</div>
